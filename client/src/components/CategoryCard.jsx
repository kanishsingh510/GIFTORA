...
export default function CategoryCard({ category, image, subtitle, count, onClick }) {
  ...
  return (
    <div 
      onClick={onClick}
      className="group relative h-60 overflow-hidden rounded-[32px] border border-slate-100 bg-white cursor-pointer shadow-sm hover:shadow-2xl transition-all duration-700"
    >
